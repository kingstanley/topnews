...
class TopNewsOverViewScreenLarge extends StatefulWidget {
  static final routeName = 'top-news-overview';
  static final apiKey = "9qapiOnguKdzg0jWODFBUMF1YLTAkHYV";

  @override
  _TopNewsOverViewScreenLargeState createState() =>
      _TopNewsOverViewScreenLargeState();
}

class _TopNewsOverViewScreenLargeState
    extends State<TopNewsOverViewScreenLarge> {
  List posts = [];
  ...
  void _getPostsFromNYTimes() async {
    try {
      ...
      String url =
          'https://api.nytimes.com/svc/topstories/v2/home.json?api-key=${TopNewsOverViewScreenLarge.apiKey}';
      http.Response response = await http.get(url);
